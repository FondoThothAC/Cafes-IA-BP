...
class DataHarvester:
    ...
    def get_competitors(self, lat: float, lon: float, keyword: str, radius_meters: int = 2000) -> dict | None:
        """
    ...
    def get_financial_indicators(self) -> dict | None:
        """
    ...
    def get_demographics(self, geo_code: str = "2603000") -> dict | None:
        """
    ...
    def get_kpis(self, geo_code: str = "26030") -> dict | None:
        """
